        ...
        <nav class="bg-gradient-to-r from-blue-500 to-blue-800 shadow-md text-white">
            <div class="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <div class="hidden md:flex space-x-8"> <!-- Espace augmenté ici -->
                    ...
                    <a class="font-medium hover:text-blue-300" href="{{ url('/tps') }}">TPs</a>
                    <a class="font-medium hover:text-blue-300" href="{{ url('/tests') }}">Tests</a>
                </div>
            ...
            <div id="mobile-menu" class="hidden md:hidden bg-gray-50">
                ...
                <a class="block text-gray-600 hover:bg-gray-200 py-2 px-4" href="{{ url('/tps') }}">TPs</a>
                <a class="block text-gray-600 hover:bg-gray-200 py-2 px-4" href="{{ url('/tests') }}">Tests</a>
            </div>
        </nav>
